...
export function createDefaultTournamentData(
  ...
  return {
    ...
    bracketPairings: [],
    columnWrappers: {
      winners1: { mode: "lines", text: "", showPlacements: false },
      winners2: { mode: "lines", text: "", showPlacements: false },
      losers1: { mode: "lines", text: "", showPlacements: false },
      losers2: { mode: "lines", text: "", showPlacements: false },
      // Top 64 additional columns (16 blocks: 8 per graphic, 4 players per block)
      ...(playerCount === 64 ? {
        // Winners graphic columns
        winners1a: { mode: "lines", text: "", showPlacements: false },
        winners1b: { mode: "lines", text: "", showPlacements: false },
        winners2a: { mode: "lines", text: "", showPlacements: false },
        winners2b: { mode: "lines", text: "", showPlacements: false },
        winners3a: { mode: "lines", text: "", showPlacements: false },
        winners3b: { mode: "lines", text: "", showPlacements: false },
        winners4a: { mode: "lines", text: "", showPlacements: false },
        winners4b: { mode: "lines", text: "", showPlacements: false },
        // Losers graphic columns
        losers1a: { mode: "lines", text: "", showPlacements: false },
        losers1b: { mode: "lines", text: "", showPlacements: false },
        losers2a: { mode: "lines", text: "", showPlacements: false },
        losers2b: { mode: "lines", text: "", showPlacements: false },
        losers3a: { mode: "lines", text: "", showPlacements: false },
        losers3b: { mode: "lines", text: "", showPlacements: false },
        losers4a: { mode: "lines", text: "", showPlacements: false },
        losers4b: { mode: "lines", text: "", showPlacements: false },
      } : {}),
    },
    bracketLabels: {
